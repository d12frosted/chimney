...
/** Provides DSL for configuring [[io.scalaland.chimney.Transformer]]'s
  ...
  */
final class TransformerInto[From, To, C <: TransformerCfg, Flags](
    val source: From,
    val td: TransformerDefinition[From, To, C, Flags]
) extends ConfigDsl[Lambda[`C1 <: TransformerCfg` => TransformerInto[From, To, C1, Flags]], C]
    with AConfigDsl[Lambda[`Flags1` => TransformerInto[From, To, C, Flags1]], Flags] {
