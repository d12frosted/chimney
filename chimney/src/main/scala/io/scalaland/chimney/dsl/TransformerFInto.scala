...
import io.scalaland.chimney.{TransformerFSupport, TransformerFlags}
import io.scalaland.chimney.internal.TransformerCfg
import io.scalaland.chimney.internal.macros.{ChimneyBlackboxMacros, TransformerFIntoWhiteboxMacros}

import scala.language.experimental.macros

final class TransformerFInto[F[+_], From, To, C <: TransformerCfg, Flags](
    val source: From,
    val td: TransformerFDefinition[F, From, To, C, Flags]
) extends ConfigDsl[Lambda[`C1 <: TransformerCfg` => TransformerFInto[F, From, To, C1, Flags]], C]
    with AConfigDsl[Lambda[`Flags1` => TransformerFInto[F, From, To, C, Flags1]], Flags] {
