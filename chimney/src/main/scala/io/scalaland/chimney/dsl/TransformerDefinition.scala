...
/** Allows customization of [[io.scalaland.chimney.Transformer]] derivation
  ...
  */
final class TransformerDefinition[From, To, C <: TransformerCfg, Flags](
    val overrides: Map[String, Any],
    val instances: Map[(String, String), Any]
) extends ConfigDsl[Lambda[`C1 <: TransformerCfg` => TransformerDefinition[From, To, C1, Flags]], C]
    with AConfigDsl[Lambda[`Flags1` => TransformerDefinition[From, To, C, Flags1]], Flags] {
