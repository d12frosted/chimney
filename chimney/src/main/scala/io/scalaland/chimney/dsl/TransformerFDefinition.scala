...
/** Allows customization of [[io.scalaland.chimney.TransformerF]] derivation
  ...
  */
final class TransformerFDefinition[F[+_], From, To, C <: TransformerCfg, Flags](
    val overrides: Map[String, Any],
    val instances: Map[(String, String), Any]
) extends ConfigDsl[Lambda[`C1 <: TransformerCfg` => TransformerFDefinition[F, From, To, C1, Flags]], C]
    with AConfigDsl[Lambda[`Flags1` => TransformerFDefinition[F, From, To, C, Flags1]], Flags] {
